...
<body>
    ...
    <!-- TABEL -->
    <div id="container">
        <table class="table table-dark table-hover" style="margin-left: auto; margin-right: auto" width="35" border="1" cellpadding="65" cellspacing="0">
            <tr>
                <th>No.</th>
                <th>Picture</th>
                <th>Full Name</th>
